...
class ParticipatedProjectListActivity : BaseActivity() {
    private val projectsAdapter : ProjectsAdapter by lazy { ProjectsAdapter() }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        projectsAdapter.addAll(loadProjectsDatas())
    }

    private fun loadProjectsDatas() : MutableList<ProjectsData>{

        val datas = mutableListOf<ProjectsData>()
