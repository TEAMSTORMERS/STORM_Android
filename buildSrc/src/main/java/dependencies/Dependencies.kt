...
object Dependencies {
    ...
    const val SOCKET = "io.socket:socket.io-client:${BuildDependenciesVersions.RECYCLE_VIEW}"
    ...
    const val FREE_DRAW_VIEW = "com.rm:freedrawview:${BuildDependenciesVersions.FREE_DRAW_VIEW}"
